...
def load_default_headers_flow():
    access_token = get_client_credentials_flow_access_token()
    headers = {"charset": "utf-8", "Accept-Language": "pl-PL", "Content-Type": "application/json",
               "Accept": 'application/vnd.allegro.public.v1+json',
               "Authorization": "Bearer {}".format(access_token)}
...
def get_client_credentials_flow_access_token():
    client_id= DefaultSettings.DEFAULT_CLIENT_ID
    client_secret= DefaultSettings.DEFAULT_CLIENT_SECRET
